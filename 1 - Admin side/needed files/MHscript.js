document.addEventListener('DOMContentLoaded', function () {
    ...
    const bookings = [
        { gender: 'female', date: '2024-06-10', time: '09:00', duration: 1 },
        { gender: 'female', date: '2024-06-10', time: '10:00', duration: 1 },
        { gender: 'female', date: '2024-06-10', time: '11:00', duration: 1 },
        { gender: 'female', date: '2024-06-11', time: '09:00', duration: 1 },
        { gender: 'male', date: '2024-06-12', time: '14:00', duration: 1 },
        { gender: 'no_preference', date: '2024-06-13', time: '16:00', duration: 1 },
        { gender: 'female', date: '2024-06-14', time: '09:00', duration: 1 },
        { gender: 'female', date: '2024-06-14', time: '10:00', duration: 1 },
        { gender: 'female', date: '2024-06-14', time: '11:00', duration: 1 },
        { gender: 'female', date: '2024-06-14', time: '12:00', duration: 1 },
        { gender: 'female', date: '2024-06-14', time: '13:00', duration: 1 },
        { gender: 'female', date: '2024-06-14', time: '14:00', duration: 1 },
        { gender: 'female', date: '2024-06-14', time: '15:00', duration: 1 },
        { gender: 'female', date: '2024-06-14', time: '16:00', duration: 1 },
        { gender: 'female', date: '2024-06-14', time: '17:00', duration: 1 },
        { gender: 'female', date: '2024-06-14', time: '18:00', duration: 1 },
        { gender: 'female', date: '2024-06-14', time: '19:00', duration: 1 },
        { gender: 'female', date: '2024-06-14', time: '20:00', duration: 1 }
    ];
    ...
    bookingForm.addEventListener('submit', function (event) {
        ...
        console.log('Booking data:', { gender, date, time, status });
        ...
        fetch('MH_booking.php', {
            ...
            body: JSON.stringify({ gender, date, time, status }),
        })
        ...
        .then(data => {
            ...
            if (data.message === "Booking successful") {
                ...
                bookings.push({ gender, date, time, status });
